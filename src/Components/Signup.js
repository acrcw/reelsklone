...
import { auth,storage, db, serverTimestamp, ref, updateProfile,uploadBytesResumable, getDownloadURL, setDoc, doc } from '../firebase';
                ...
                () => {
                    ...
                    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                        ...
                        updateProfile(auth.currentUser, {
                            displayName: `${Fullname}`, photoURL: `${downloadURL}`
                          }).then(() => {
                        ...
                        <Grid container spacing={2}>
                            ...
                            {!open && <Grid item xs={12}>
                                <FormControlLabel
                                    ...
                                    label={<Typography fontSize={'12px'} >By signing up, you agree to our Terms , Privacy Policy and Cookies Policy.</Typography>}
                                />
                            </Grid>}
                        </Grid>
